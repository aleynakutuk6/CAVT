...
class CAVTPreprocessor:
    ...
    def __init__(self, crop_margins: bool=True, 
                 segm_side_padding: int=50, max_side_dim: int=640, 
                 white_bg: bool=True, color_fg: bool=True,
                 thickness: int=2):
        ...
        self.side_pad = segm_side_padding
    ...
    def create_class_segmentation_mtx(
        self, scene_strokes, obj_divisons, class_ids, W, H):
